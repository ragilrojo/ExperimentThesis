...
# Cell 4: Diagnostics Calculation
notebook["cells"].append(create_code_cell([
    "# --- 3. Run Diagnostics ---\n",
    "\n",
...
# Cell 5: Advanced Simulation (Turnover)
notebook["cells"].append(create_code_cell([
...
# Cell 6: Visualizing the Problem
notebook["cells"].append(create_code_cell([
...
# Save
output_path = r"g:\My Drive\00_Kuliah\Thesis\sharpenThesis_dpInsya\experiment_nextLevel3\diagnose_v42.ipynb"
