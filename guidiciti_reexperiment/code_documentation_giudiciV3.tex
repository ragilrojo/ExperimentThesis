...
\begin{enumerate}
    ...
    \item \textbf{Graph Diversification}: Strategi diversifikasi berbasis teori graf menggunakan \textit{Maximum Independent Set} (MIS) dengan threshold ($\theta$) statis.
    \item \textbf{Dynamic Graph Diversification (ML Level 1)}: Model pengembangan yang mengoptimalkan ambang batas korelasi ($\theta$) secara dinamis melalui \textit{rolling cross-validation}. Strategi ini menyelesaikan kelemahan $\theta$ statis yang sering gagal menemukan aset independen saat pasar bergejolak (korelasi meningkat serentak).
\end{enumerate}
...
class DynamicGraphDiversification(PortfolioStrategy):
    """
    Strategi diversifikasi graf dengan optimasi ambang batas korelasi secara dinamis (Machine Learning Level 1).
    Menggunakan rolling validation window untuk mencari nilai theta (grid search) yang 
    memaksimalkan Sharpe Ratio, mencegah kegagalan pembentukan MIS saat bergejolak.
    """
    def __init__(self, name='Dynamic Graph Divers. (ML)'):
        super().__init__(name)

    def optimize_theta(self, returns_data):
        # Grid Search melalui rolling validation (Train 80%, Val 20%)
        ...
        # Iterasi hyperparameter tuning untuk theta
        for theta in np.arange(0.1, 1.0, 0.1):
            # 1. Bangun MIS berbasis data train
            sel = get_assets_graph_diversify(train_data, theta)
            n = train_data.shape[1]
            w = np.zeros(n)
            
            # 2. Hitung bobot equal-weight dalam MIS
            if sel:
            ...
            # 3. Evaluasi performa di data validation
            val_returns = val_data.dot(w)
            
            # 4. Hitung Sharpe Ratio (Hindari pembagian dengan nol)
            if val_returns.std() > 1e-6:
                sharpe = val_returns.mean() / val_returns.std()
            else:
                sharpe = 0
                
            # 5. Update best_theta jika Sharpe lebih baik
...
\begin{table}[h]
    ...
    \begin{tabular}{lccccccccccc}
        \toprule
        Period & CRIX & EW & CM & GM & NW(0) & NW(0.15) & NW(1.0) & GD(0.4) & RMT-GD & ML-GD & AGGP \\
        \midrule
        Jan-2018 & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        May-2018 & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        Sep-2018 & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
...
\begin{table}[h]
    ...
    \begin{tabular}{lccccccccccc}
        \toprule
        Market Phase & CRIX & EW & CM & GM & NW(0) & NW(0.15) & NW(1.0) & GD(0.4) & RMT-GD & ML-GD & AGGP \\
        \midrule
        \multicolumn{12}{c}{\textit{Panel A: Sharpe Ratio}} \\
        Bearish  & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        Recovery & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        Stable   & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        \midrule
        \multicolumn{12}{c}{\textit{Panel B: Rachev Ratio ($\alpha=10\%$)}} \\
        Bearish  & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        Recovery & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        Stable   & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... & ... \\
        \bottomrule
