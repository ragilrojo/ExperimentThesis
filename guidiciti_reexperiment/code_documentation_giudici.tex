...
\begin{enumerate}
    ...
    \item \textbf{Classical Markowitz 30 (CM 30)}: Varian CM dengan \textit{rolling window} 30 hari untuk perbandingan \textit{baseline} yang lebih adil terhadap model adaptif.
...
strategies = [
    ...
    ClassicalMarkowitz("CM 30", window_size=30),
    GlassoMarkowitz("GM"),
