...
- **[v5] `plot_convergence_analysis()`: 3-panel justifikasi konvergensi (mean reward, rolling std, diminishing returns per 5k-step interval)**
...
3. **Panel 3** — ΔReward per 5k-step interval (diminishing returns): mendekati nol di akhir training.
